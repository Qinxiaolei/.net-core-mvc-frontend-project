...
export class CLogin extends CClsBase {
    ...
    renewInnerUI() {
        let oThis = this;
        let eContainer = document.getElementById(S_DEFINE.elementIdDict.cLoginModalId);
        if (eContainer)
            eContainer.innerHTML = oThis.getInnerHtml();
    }
    //刷新登录页UI
    renewLoginUI() {
        let oThis = this;
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0">
                <div class="modal-header border-0">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="${eleIdDict.cBtnCloseLoginModalId}"></button>
                </div>
    ...
    getHtml() {
        ...
        let oThis = this;
        let cHtml = `
        <button type="button" class="d-none" data-bs-toggle="modal" data-bs-target="#${eleIdDict.cLoginModalId}" id="${eleIdDict.cBtnOpenLoginModalId}"></button>
        <div class="modal fade" id="${eleIdDict.cLoginModalId}">
            ${oThis.getInnerHtml()}
        </div>`;
        return cHtml;
    }
